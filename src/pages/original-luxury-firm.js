    ...
    <>
      ...
      <section className="mt-4 mb py-5" style={{ backgroundColor: '#fff' }}>
        <Container>
          <Row className="no-gutters pb-2 pb-sm-5">
            ...
            <Col
              sm="6"
              className="pl-0 pl-sm-5 color-primary pt-4 pt-sm-0 col-12"
            >
              <h3 className="erbaum-bold pb-3 color-primary">
                THE ORIGINAL CHIROFOAM<sup style={{ fontSize: '16px' }}>TM</sup>{' '}
                MATTRESS - LUXURY FIRM
              </h3>
              <p
                className="filson-pro-reg space-1 col-sm-12 col-lg-7 col-12 px-0"
                style={{ fontSize: '14px' }}
              >
                The Original Chirofoam Memory Foam Mattress is designed to
                increase muscle recovery to help keep you performing at your
                best. Made in Toronto, ON. Upgrade your sleep today!
              </p>
              <p
                className="filson-pro-reg space-1 col-sm-12 col-lg-7 col-12 px-0"
                style={{ fontSize: '14px' }}
              ...
              <p
                ...
                style={{ fontSize: '14px' }}
              >
                Free Delivery across Canada and Continental USA.
              </p>
              <p
                className="filson-pro-reg space-1 col-sm-12 col-lg-7 col-12 px-0"
                style={{ fontSize: '14px' }}
      ...
      <section className="mt-4 py-5 max-support-single">
        <Container>
          <Row className="">
            <Col sm="4">
              <h2 className="display-3 erbaum-bold text-white">
