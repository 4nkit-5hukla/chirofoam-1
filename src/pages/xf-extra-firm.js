        ...
        <Container>
          <Row className="no-gutters pb-2 pb-sm-5">
            ...
            <Col sm="6" className="pl-lg-5 pl-0 pt-3 pt-sm-0 color-primary">
              <h3 className="erbaum-bold pb-3 color-primary">
                THE CHIROFOAM<sup style={{ fontSize: '16px' }}>TM</sup> XF
                MATTRESS - EXTRA FIRM
              </h3>
              <p
                className="filson-pro-reg space-1 col-12 col-sm-12 col-lg-7 px-0"
                style={{ fontSize: '14px' }}
              >
                Introducing the new Chirofoam<sup>TM</sup> XF Memory Foam
                mattress. An extra firm mattress designed for maximum support.
                Made in Toronto, ON.
              </p>
              <p
                className="filson-pro-reg space-1 col-12 col-sm-12 col-lg-7 px-0"
              ...
              <div className="d-flex text-center pt-3 pl-sm-0 pl-lg-5 pl-0 facilities">
                <Col sm="4" className="px-2 px-sm-3">
                  ...
                  <Link to="/warranty/">
                    <span
                      className="d-block erbaum-bold color-primary"
                ...
                <Col sm="4" className="px-2 px-sm-3">
                  ...
                  <span
                    ...
                    style={{ fontSize: '0.8rem' }}
                  >
                    FREE EXPRESS DELIVERY AND{' '}
                    <Link className="color-primary" to="/return-policy/">
                      EASY RETURNS
                    </Link>
                  </span>
                </Col>
                <Col sm="4" className="px-2 px-sm-3">
                  ...
                  <span
                    className="d-block erbaum-bold"
                    style={{ fontSize: '0.8rem' }}
                  >
                    DELIVERED IN PORTABLE BOX
                  </span>
                </Col>
              </div>
              <div className="row text-center text-lg-left no-gutters mt-4 ml-0">
                <div className="col-sm-6 col-lg-2 col-4 mb-2">
                  <span
                    id="cali"
                    variants="DIMENSIONS: 54″ X 75″ X 12″"
                    price="CAD $1090.00"
                    className="text-center border d-block py-2 variants active"
                    style={{ fontSize: '0.6rem', width: '95%' }}
                  >
                    CALI KING
                  </span>
                </div>
                <div className="col-sm-6 col-lg-2 col-4 mb-2">
                  <span
                    ...
                    variants="DIMENSIONS: 54″ X 75″ X 12″"
                    price="CAD $890.00"
                    className="text-center border d-block py-2 variants"
                    style={{ fontSize: '0.6rem', width: '95%' }}
                  >
                    KING
                  </span>
                ...
                <div className="col-sm-6 col-lg-2 col-4 mb-2">
                  <span
                    id="queen"
                    variants="DIMENSIONS: 76″ X 80″ X 12″"
                    price="CAD $1090.00"
                    className="text-center border d-block py-2 variants"
                    style={{ fontSize: '0.6rem', width: '95%' }}
                  >
                ...
                <div className="col-sm-6 col-lg-2 col-4 mb-2">
                  <span
                    id="double"
                    variants="DIMENSIONS: 60″ X 80″ X 12″"
                    price="CAD $990.00"
                    className="text-center border d-block py-2 variants"
                    style={{ fontSize: '0.6rem', width: '95%' }}
                  >
                ...
                <div className="col-sm-6 col-lg-2 col-4 mb-2">
                  <span
                    id="single"
                    variants="DIMENSIONS: 39″ X 75″ X 12″"
                    price="CAD $690.00"
                    className="text-center border d-block py-2 variants"
                    style={{ fontSize: '0.6rem', width: '95%' }}
                  >
                ...
                <div className="col-sm-6 col-lg-2 col-4 mb-2">
                  <span
                    id="twin"
                    variants="DIMENSIONS: 39″ X 80″ X 12″"
                    price="CAD $740.00"
                    className="text-center border d-block py-2 variants"
                    style={{ fontSize: '0.6rem', width: '95%' }}
                  >
              ...
              >
                <b className="proxima-eb">
                  Our specilized layer of chirofoam<sup pr>TM</sup> lumbar
                  support
                </b>{' '}
        ...
        <Container>
          <Row>
            <div className="position-absolute card-content">
              <h4 className="px-3 px-sm-0 lead-text-font text-white erbaum-bold display-5 text-center">
                4 OUT OF 5 CONSUMERS SERVEYED SAID CHIROFOAM<sup>TM</sup> IS
                MORE COMFORTABLE COMPARED TO OTHER COMFORTABLE BEST SELLING
                MATTRESS BRANDS.
              </h4>
            </div>
          </Row>
